...
python3 -u $ARTIFACTS_DECOMPRESSED_PATH/provide_config.py --grafana_hostname $GRAFANA_INTERFACE --grafana_port $GRAFANA_PORT --grafana_server_protocol $SERVER_PROTOCOL & 
